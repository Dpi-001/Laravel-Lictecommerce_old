...
<table class="w-full mt-5">
    ...
    <tr class="text-center">
        ...
        <td class="border p-2">
            <a href="{{route('category.edit',$category->id)}}" class="bg-blue-900 text-white px-3 py-1 rounded">Edit</a>
...
<div class="fixed bg-gray-600 inset-0 bg-opacity-50 backdrop-blur-sm hidden items-center justify-center" id="popup">
    ...
    <form action="{{route('category.destory')}}" method="POST" class="bg-white px-10 py-5 rounded-lg text-center">
        @csrf
        @method('DELETE')
